<?php
	...
	if($_POST) {
			...
			//$num = $statement->rowCount();
				...
				echo "<div id='Print'>";
					echo "<div class='page-header'>";
						echo"<h1>Laporan Penjualan <small> Cendikia SALON & SPA</small></h1>";
						echo"<small>Dari Tanggal {$datefrom} Sampai {$dateto} </small>";
					echo"</div>";
				echo "<table class='table table-striped'>";
					echo "<tr>";
						echo "<th>No</th>";
						echo "<th>Barang / Jasa</th>";
			...
			$statement = $laporan->ShowPenjualanByDate($datefrom, $dateto);
			$no = 0;
			$total = 0;
...
echo "<div class='row' style='border-top: 1px solid black'>";
			echo "<p class='pull-right'>Total Penjualan = <b>" .number_format($stotal, 2, '.', ',') . "</b></p>";
echo "</div>";
